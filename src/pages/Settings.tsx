    ...
    <MobileLayout>
      <div className="space-y-6">
        ...
        <div className="space-y-1">
          ...
          <Link to="/settings/personal" className="w-full flex items-center justify-between p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
          ...
          <Link to="/settings/security" className="w-full flex items-center justify-between p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
            <div className="flex items-center space-x-3">
          ...
          <Link to="/settings/notifications" className="w-full flex items-center justify-between p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
            <div className="flex items-center space-x-3">
              <Bell size={20} className="text-gray-600 dark:text-gray-300" />
              <span>Notification Preferences</span>
            </div>
            <div className="flex items-center">
              <Badge variant="secondary" className="mr-2">3 New</Badge>
              <ChevronRight size={18} className="text-gray-400" />
            </div>
          </Link>
          
          <Link to="/settings/payment" className="w-full flex items-center justify-between p-4 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800">
            <div className="flex items-center space-x-3">
        ...
        {/* Additional sections */}
        <div className="space-y-1">
          <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 mb-2 pl-1">Preferences</h3>
