	...
	const steps: OnboardingStep[] = [
		{
			...
			description:
				"Monitor your energy consumption in real-time and get insights on your usage patterns.",
		},
		{
			icon: <Clock size={48} className="text-bayelsa-teal" />,
			title: "Pay Bills with Ease",
			description:
				"Conveniently pay your electricity bills on time from the comfort of your home.",
		},
		{
			icon: <ChartBar size={48} className="text-bayelsa-teal" />,
			title: "Analyze Your Consumption",
			description:
				"View detailed analytics of your energy usage and get tips on how to save more.",
		},
		{
			icon: <Shield size={48} className="text-bayelsa-teal" />,
			title: "Secure & Reliable",
			description:
				"Your data is protected with advanced security measures for your peace of mind.",
		},
	];
			...
			<div className="flex flex-col items-center justify-between min-h-screen p-6 bg-gradient-to-b from-white to-bayelsa-light dark:from-gray-900 dark:to-gray-800 animate-fade-in">
				...
				<div className="w-full flex justify-center pt-8">
					<div className="flex items-center justify-center space-x-1">
						<span className="text-3xl font-bold text-bayelsa-blue dark:text-white">
							B
						</span>
						...
						<div className="flex items-center">
							...
							<span className="text-3xl font-bold text-bayelsa-blue dark:text-white ml-3">
								POWER
							</span>
						</div>
					</div>
				...
				<div className="w-full flex flex-col items-center justify-center flex-1 py-8">
					<Carousel
						className="w-full"
						setApi={(api) => api?.scrollTo(currentStep, true)}
					>
						<CarouselContent>
