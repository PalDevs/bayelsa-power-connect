      ...
      <div className="flex flex-col items-center justify-between min-h-screen p-6 bg-white dark:bg-gray-900 animate-fade-in">
        ...
        <div className="w-full flex flex-col items-center space-y-8">
          <div className="relative flex flex-col items-center">
            <div className="w-40 h-40 rounded-full bg-bayelsa-light dark:bg-bayelsa-blue/20 flex items-center justify-center mb-6">
              <img 
                src="/lovable-uploads/ac14222c-b733-4c97-b5c5-674553c18709.png" 
                alt="Power Icon" 
            ...
            <p className="text-gray-500 dark:text-gray-400 text-center max-w-xs">
              Pay bills and track your usage easily with BAY POWER!
            </p>
          </div>
        </div>
